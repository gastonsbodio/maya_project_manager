...
control_tuple = [ ('Arm','L') , ('Arm','R') , ('Leg','L') , ('Leg','R')  ]
                    #### , ( 'Fingers1_%s' , 'IK%s_%s', 'IKFingers1_%s' )
list_tuple_na_front = [( 'Scapula_%s' , 'FKScapula_%s' ) , ( 'Wrist_%s' , 'IK%s_%s', 'FKMiddleFinger1_%s') , ( 'Pole%s_%s_ref' , 'Pole%s_%s' ) , 
                    ( 'Scapula5_%s' , 'FKScapula_%s' ) , ( 'Pole%s_%s_ref' , 'Pole%s_%s' ) ,( 'Scapula5_%s' , 'FKScapula_%s' ) ,
                    ( 'Scapula5_%s' , 'FKScapula_%s' ) , ( 'Pole%s_%s_ref' , 'Pole%s_%s' ) ,( 'Scapula5_%s' , 'FKScapula_%s' ) ]
                    ####   , ( 'Toes1_%s' , 'IKLeg%s_%s' , 'IKToes1_%s')
list_tuple_na_back= [( 'Hip_%s' , 'FKHip_%s' ), ( 'Ankle_%s' , 'IK%s_%s')  , ( 'Pole%s_%s_ref' , 'Pole%s_%s' ) , 
...
def limb_fk_2_ik( signalAnim=False ):
    control_name = cmds.ls( sl=True )
    print( '    control_name                             control_name             control_name')
    print( control_name )
    control_name=control_name[0]
    for tup in control_tuple: 
