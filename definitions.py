...
MAYA_MENU_SUBFOL = '/art-tools/sksMaya/MayaEnv/ui/'
MAYA_MENU_FOL = USER_DOC.replace( '\\','/' ) + '/' + COMPANY_TOOLS_FOL + MAYA_MENU_SUBFOL
...
GOOG_CONTENT_TOOLS_FOL = DEFIN_DICC['KEYW']['GOO_SH_INFO']['GOOG_CONTENT_TOOLS_FOL']
...
GOOGLE_SH_ANI_NA_COL = DEFIN_DICC['KEYW']['GOO_SH_INFO']['GOOGLE_SH_ANI_NA_COL']
GOOGLE_SH_CREAT_AREA_COL = DEFIN_DICC['KEYW']['GOO_SH_INFO']['GOOGLE_SH_CREAT_AREA_COL']
GOOGLE_SH_CREAT_PATH = DEFIN_DICC['KEYW']['GOO_SH_INFO']['GOOGLE_SH_CREAT_PATH']
GOOGLE_SH_ANIM_ASSET_COL = DEFIN_DICC['KEYW']['GOO_SH_INFO']['GOOGLE_SH_ANIM_ASSET_COL']
GOOGLE_SH_ISSUE_KEY = DEFIN_DICC['KEYW']['GOO_SH_INFO']['GOOGLE_SH_ISSUE_KEY']
...
TASK_TRACKER_SHEET = 'Task Tracker Sheet'
